...
/* package TontinePolicy-0.1.0.0 */
#ifndef VERSION_TontinePolicy
#define VERSION_TontinePolicy "0.1.0.0"
#endif /* VERSION_TontinePolicy */
#ifndef MIN_VERSION_TontinePolicy
#define MIN_VERSION_TontinePolicy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_TontinePolicy */
...
#define CURRENT_COMPONENT_ID "TontinePolicy-0.1.0.0-inplace-TontineSmartcontract"
